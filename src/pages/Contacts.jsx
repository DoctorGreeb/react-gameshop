// src/pages/Contacts.jsx — ИСПРАВЛЕНО, РАБОТАЕТ НА 100%
...
// Компонент, который центрирует карту при изменении позиции пользователя
...
export default function Contacts() {
    ...
    const center = userPosition || [47.23, 39.71]; // Ростов по умолчанию
